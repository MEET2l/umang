...
<section class="hero">
    ...
    <div class="hero-right">
        <div class="circle">
            <div class="wrapper"><img src="images/u-kid.png" class="circle-pic" alt="UMANG-KID"></div>
        </div>
    </div>
</section>
...
<section class="umang-block">
    ...
    <div class="umang-img-box">
        <img src="images/umang-center.png" alt="Umang Center">
    </div>
...
<div class="benefit-section">
    ...
    <div class="benefit-img">
        <img src="images/benefit.png" alt="Benefits Image">
    </div>
...
<section class="partner-section">
    ...
    <div class="partner-inner">
        ...
        <!-- left image -->
        <img class="flying-pencil" src="images/Flying pencil.png" alt="Flying pencil">
        ...
        <!-- right image -->
        <img class="bag-chair" src="images/Bag and chair.png" alt="Bag and chair">
...
<section class="photo-slider">
    ...
    <div class="slider-container">
        ...
        <div class="slides">
            <img src="images/slide-img (1).png" class="slide active">
            <img src="images/slide-img (2).png" class="slide active">
            <img src="images/slide-img (3).png" class="slide active">
            <img src="images/slide-img (4).png" class="slide active">
            <img src="images/slide-img (5).png" class="slide active">
            <img src="images/slide-img (6).png" class="slide active">
            <img src="images/slide-img (7).png" class="slide active">
            <img src="images/slide-img (8).png" class="slide active">
            <img src="images/slide-img (9).png" class="slide active">
            <img src="images/slide-img (10).png" class="slide active">
            <img src="images/slide-img (11).png" class="slide active">
            <img src="images/slide-img (12).png" class="slide active">
            <img src="images/slide-img (13).png" class="slide active">
        </div>
...
<section class="sec">
    <div class="row">
        <div class="left">
            <img src="images/u-kid.png" alt="Parent Toddler">
        </div>
...
<section class="sec">
    <div class="row reverse">
        ...
        <div class="left">
            <img src="images/palaka.png" alt="Parents Training">
        </div>
    ...
    <div class="sixT-cards">
        ...
        <div class="flip-card">
            <div class="flip-inner">
                ...
                <div class="flip-front">
                    <img src="images/पालकांचा-सक्रिय-सहभाग.jpg">
        ...
        <div class="flip-card">
            <div class="flip-inner">
                ...
                <div class="flip-front">
                    <img src="images/मुलांच्या-गरजांनुसार-उपक्रम.jpg">
        ...
        <div class="flip-card">
            <div class="flip-inner">
                ...
                <div class="flip-front">
                    <img src="images/पालक-क्षमता-विकास-सत्र.jpg">
        ...
        <div class="flip-card">
            <div class="flip-inner">
                ...
                <div class="flip-front">
                    <img src="images/सुरक्षित-व-आनंददायी-वातावरण.jpg">
                    <h3>सुरक्षित वातावरण</h3>
                </div>
        ...
        <div class="flip-card">
            <div class="flip-inner">
                ...
                <div class="flip-front">
                    <img src="images\तज्ज्ञ-मार्गदर्शन.jpg">
        ...
        <div class="flip-card">
            <div class="flip-inner">
                ...
                <div class="flip-front">
                    <img src="images/समूह-चर्चा-व-अनुभव-शेअर.jpg">
                    <h3>समूह चर्चा</h3>
                </div>
